...
public class Property {
    ...
    public void SetMACAddressL(String MACAddress) {
        this.MACAddress = MACAddress;
    }

    public Property(Context myContext) throws IOException {
        AssetManager mg = myContext.getAssets();
        InputStream is = null;
        try {
            is = mg.open("Config.xml");
