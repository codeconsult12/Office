...
namespace iNTrack
{
    public static class InteropLib
    {
        ...
        [DllImport("coredll.dll", CharSet = CharSet.Unicode, ExactSpelling = false, SetLastError = true)]
        ...
        [DllImport("coredll.dll", CharSet = 1, ExactSpelling = false, SetLastError = true)]
        ...
        [DllImport("coredll.dll", CharSet = 1, ExactSpelling = false)]
        ...
        [DllImport("coredll", CharSet = 1, ExactSpelling = false)]
        ...
        [DllImport("cellcore.dll", CharSet = 1, ExactSpelling = false)]
        ...
        [DllImport("coredll", CharSet = 1, ExactSpelling = false, SetLastError = true)]
        ...
        [DllImport("voicectl.dll", CharSet = 1, ExactSpelling = false)]
